        ...
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 md:ml-3 gap-5">
            <a href="#" class="max-w-sm p-5 bg-white border border-gray-200 rounded-lg shadow duration-300 transition-all hover:bg-slate-100">
                <div>
                    ...
                    <p class="mb-3 font-normal">Your school have {{ $school->book->count() }} books. Let's read the book in order to add our
                        knowledge.</p>
                </div>
            </a>
            <a href="#" class="max-w-sm p-5 bg-white border border-gray-200 rounded-lg shadow mt-3 duration-300 transition-all hover:bg-slate-100">
                <div>
                    <div class="flex items-center gap-x-2">
                    ...
                    <p class="mb-3 font-normal">Your school have {{ $school->classroom->count() }} classrooms. Let's see the
