    ...
    <div class="grid justify-center items-center">
        ...
        @if ($previlage->role == 'owner' || $previlage->role == 'operator' || $previlage->id == $homeroom?->id)
            <button type="button" data-modal-target="timepicker-modal" data-modal-toggle="timepicker-modal"
                ...
                <i class="fa-solid fa-clock"></i> Make absen student
            </button>
        ...
        <p class="bg-red-100 text-red-800 text-sm font-medium px-2.5 py-2 rounded ">Absen Belum dilakukan</p>
        ...
        <p class="bg-green-100 text-green-800 text-sm font-medium px-2.5 py-2 rounded ">Absen yang sudah dilakukan</p>
        <div class="shadow-md sm:rounded-lg my-3">
            <table class="w-full text-sm">
                <thead class="text-xs uppercase bg-slate-200 ">
                    <tr>
