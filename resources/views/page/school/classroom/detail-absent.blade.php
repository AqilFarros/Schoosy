...
@section('content')
    ...
    @if ($absent->absentClassNote->count() !== 0)
        <p class="mx-4 my-1 md:mx-5 md:my-1 p-2 text-white border-zinc-900 border-[1px] rounded-xl bg-blue-500 flex flex-col"><span class="font-semibold bg-blue-800 size-fit py-1 px-2 rounded-lg">NOTE</span> {{ $absent->absentClassNote->first()->note }}</p>
    @endif
@endsection
